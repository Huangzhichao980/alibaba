...
{
    protected $rule = [
        'method|api接口名称' => 'length:0,100',
        'app_key|app_key' => 'length:0,50',
        'target_app_key|目标app_key' => 'length:0,30',
        'sign_method|签名方法' => 'in:hmac,md5',
        'sign|签名' => 'length:0,100',
        'session|登录授权session' => 'length:0,100',
        'timestamp|时间戳' => 'dateFormat:Y-m-d H:i:s',
        'format|响应格式' => 'in:xml,json',
        'v|api协议版本' => 'length:0,5',
        'partner_id|合作伙伴身份标识' => 'length:0,30',
        'simplify|是否采用精简json格式返回' => 'in:true,false',
        'nick|用户昵称' => 'length:0,20',
        'fields|返回参数字段' => 'length:0,50',
        'client_id|客户端id' => 'length:0,50',
        'response_type|授权类型' => 'in:code,token',
        'redirect_uri|回调地址' => 'length:0,255',
        'state|应用状态' => 'length:0,50',
        'view|页面样式' => 'in:web,tmall,wap',
        'client_secret|客户端密钥' => 'length:0,255',
        'code|code码' => 'length:0,255',
        'grant_type|授权类型' => 'length:0,50',
        'src_mix_nick|混淆昵称' => 'length:0,128',
        'src_appkey|输入的appkey' => 'length:0,50',
        'tb_user_id|淘宝用户id' => 'number',
        'open_uid|基于Appkey生成的open security淘宝用户Id' => 'length:0,50',
        'open_account_ids|Open Account的id列表' => 'array',
        'isv_account_ids|ISV自己账号的id列表' => 'array',
        'param_list|Open Account' => 'array',
        'OwnerAppkey|appkey' => 'length:0,50',
        'query|查询信息' => 'length:0,100',
        'param_token|token' => 'length:0,100',
        'token_timestamp|时间戳（单位毫秒）' => 'number',
        'open_account_id|open account id' => 'number',
        'isv_account_id|isv自己账号的唯一id' => 'length:0,50',
        'uuid|用于防重放的唯一id' => 'length:0,100',
        'login_state_expire_in|ISV APP的登录态时长单位是秒' => 'number',
        'ext|用于透传一些业务附加参数' => 'json',
        'index_type|int MOBILE = 1;int EMAIL = 2;int ISV_ACCOUNT_ID = 3;int LOGIN_ID = 4;int OPEN_ID = 5;' => 'in:1,2,3,4,5',
        'index_value|具体值' => 'length:0,50',
        'grade_id|检查金额档位id' => 'length:0,100',
        'param_settle_adjustment_request|结算调整单父节点' => 'array',
        'num_iid|商品id' => 'number',
        'count|返回量' => 'number',
        'platform|链接形式' => 'in:1,2',
        'text|口令弹窗内容' => 'length:0,50',
        'url|口令跳转目标页' => 'length:0,255',
        'favorites_id|favorites_id' => 'number',
        'adzone_id|推广位id' => 'number',
        'unnamed|鉴权'=>'length:0,50',
        'param|参数'=>'array',
        'right_ename|发放的权益唯一标识'=>'length:0,100',
        'receiver_id|接收奖品的用户openid'=>'length:0,100',
        'user_type|用户类型'=>'length:0,100',
        'unique_id|幂等校验id'=>'length:0,100',
        'app_name|mtop'=>'length:0,100',
        'ip|ip地址'=>'length:0,100',
        'ename|奖池唯一标识'=>'length:0,100',
        'verify_code|验证码'=>'length:0,10',
        'phone|手机号码'=>'length:11,11',
        'data_set_id|数据集id'=>'length:0,100',
        'query|用户query'=>'length:0,255',
        'param0|参数'=>'array',
        'q|查询词'=>'length:0,255',
        'sort|排序'=>'length:0,50',
        'is_tmall|是否商城的店铺'=>'boolean',
        'start_credit|信用等级下限'=>'number',
        'end_credit|信用等级上限'=>'number',
        'start_commission_rate|淘客佣金比率下限'=>'number',
        'end_commission_rate|淘客佣金比率上限'=>'number',
        'start_total_action|店铺商品总数下限'=>'number',
        'end_total_action|店铺商品总数上限'=>'number',
        'start_auction_count|累计推广商品下限'=>'number',
        'end_auction_count|累计推广商品上限'=>'number',
        'page_no|第几页'=>'number',
